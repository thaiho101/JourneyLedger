...
function CreateJourneyPage() {
    ...
    async function handleCreateJourney(event) {
        try {
            ...
            const data = await createJourney(journeyName, originCountry, destinationCountry, fromDate, toDate, defaultCurrency);

            console.log(data);

            if (data) {
                alert("🎉 Congratulations! New journey created successfully!")
                navigate("/journeys");
                return;
            }
            ...
            console.log(error);
            alert("❌ Error: Create journey failed! Please try again.");
        }
    ...
    return (
        <AppLayout title="Create Journey">
            <div className="page-container">
                <div className="journey-form-card">
                    <form className="journey-form" onSubmit={handleCreateJourney}>
